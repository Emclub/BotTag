                ...
                if msg.text != None:
                    if msg.toType == 2:
                        ...
                        if may in str(msg.contentMetadata) and 'MENTION' in str(msg.contentMetadata):
                            pilih = ['คิดถึงเอ็มมากขนาดนั้นเลยหรอ','เรียกหาเอ็ม มีรายหรอคร้าบ, เอ็มมาแล้ววว มีรายอ่า','เอ็มไม่ว่าง?','เอ็มไม่รุไม่ชี้, มีรายหราา','ถามหาเอ็มทำมั้ยอ่าา, คิดถึงเอ็มหรอ']
                    ...
                    if msg.contentType == 0:
                        if msg.toType == 2:
                            ...
                            if text.lower() == 'เอ็ม':
                                ...
                                start = time.time()
                                client.sendText(receiver, "ทดสอบความเร็วเอ็ม Bot Self")
                                elapsed_time = time.time() - start
                                client.sendText(receiver, "%sdetik" % (elapsed_time))
                            elif 'รูป' in text.lower():
                                try:
                                ...
                                client.sendText(receiver, "สมาชิก:"+str(jml))
                    ...
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                pref=['ฮั่นแน่!!..เอ็มเห็นน่ะ','แอบดูรายหรา','มาคุยกับเค้าหน่อย','แอบดีกันจัง','ห้ามแอบ มาๆๆ คุยกัน','มาๆๆๆ เอ็มหรอยู่','ไม่กัดหรอกไม่ต้องแอบ']
